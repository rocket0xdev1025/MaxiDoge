...
var w = class extends L {
  ...
  update(t) {
    B(this);
    let { view: n, buffer: s, blockLen: i } = this;
    t = C(t);
    let o = t.length;
    for (let e = 0; e < o; ) {
      ...
      s.set(t.subarray(e, e + h), this.pos),
        (this.pos += h),
        (e += h),
  ...
  digestInto(t) {
    B(this), A(t, this), (this.finished = !0);
    let { buffer: n, view: s, blockLen: i, isLE: o } = this,
      { pos: e } = this;
    (n[e++] = 128),
      this.buffer.subarray(e).fill(0),
      this.padOffset > i - e && (this.process(s, 0), (e = 0));
    for (let c = e; c < i; c++) n[c] = 0;
    H(s, i - 8, BigInt(this.length * 8), o), this.process(s, 0);
    let h = g(t),
      f = this.outputLen;
...
var I = (r, t, n) => (r & t) ^ (~r & n),
  ...
  y = class extends w {
    ...
    get() {
      let { A: t, B: n, C: s, D: i, E: o, F: e, G: h, H: f } = this;
    ...
    process(t, n) {
      ...
      for (let c = 16; c < 64; c++) {
        ...
        d[c] = (m + d[c - 7] + U + d[c - 16]) | 0;
      }
      let { A: s, B: i, C: o, D: e, E: h, F: f, G: x, H: b } = this;
      for (let c = 0; c < 64; c++) {
        let p = a(h, 6) ^ a(h, 11) ^ a(h, 25),
          l = (b + p + I(h, f, x) + E[c] + d[c]) | 0,
          m = ((a(s, 2) ^ a(s, 13) ^ a(s, 22)) + D(s, i, o)) | 0;
        (b = x),
          (x = f),
          (f = h),
          (h = (e + l) | 0),
