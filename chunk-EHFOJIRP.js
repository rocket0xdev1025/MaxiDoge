var r =
  typeof globalThis == "object" && "crypto" in globalThis
    ? globalThis.crypto
    : void 0;
var f = (t) => t instanceof Uint8Array;
var g = (t) =>
    new Uint32Array(t.buffer, t.byteOffset, Math.floor(t.byteLength / 4)),
  h = (t) => new DataView(t.buffer, t.byteOffset, t.byteLength),
  x = (t, e) => (t << (32 - e)) | (t >>> e),
  s = new Uint8Array(new Uint32Array([287454020]).buffer)[0] === 68;
if (!s) throw new Error("Non little-endian hardware is not supported");
function a(t) {
  if (typeof t != "string")
...
function u(t) {
  if ((typeof t == "string" && (t = a(t)), !f(t)))
    throw new Error(`expected Uint8Array, got ${typeof t}`);
  return t;
}
function b(...t) {
  let e = new Uint8Array(t.reduce((o, i) => o + i.length, 0)),
    n = 0;
  return (
    t.forEach((o) => {
      if (!f(o)) throw new Error("Uint8Array expected");
...
function m(t) {
  let e = (o, i) => t(i).update(u(o)).digest(),
    n = t({});
  return (
    (e.outputLen = n.outputLen),
    (e.blockLen = n.blockLen),
