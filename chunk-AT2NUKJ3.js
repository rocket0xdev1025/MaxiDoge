import { l as O } from "./chunk-UUTKIRVD.js";
var Ue = Symbol(),
  pe = Symbol();
      ...
      return (
        ...
        Reflect.ownKeys(r).forEach((S) => {
          ...
          let W = Reflect.get(r, S),
            M = { value: W, enumerable: !0, configurable: !0 };
          if (K.has(W)) q(W, !1);
    ...
    A = (r) => {
      ...
      return (
        ...
        Reflect.ownKeys(r).forEach((i) => {
          ...
          "value" in a && (($[i] = r[i]), delete a.value, delete a.writable),
            Object.defineProperty(F, i, a);
        }),
        $
      );
    }
...
var d = C({ history: ["ConnectWallet"], view: "ConnectWallet", data: void 0 }),
  de = {
    state: d,
    subscribe(e) {
      return D(d, () => e(d));
    ...
    setModalVersionInStorage() {
      try {
        typeof localStorage < "u" &&
          localStorage.setItem(f.WCM_VERSION, "2.6.2");
      } catch {
  ...
  x = {
    ...
    setConfig(e) {
      var t, s;
      be.initialize(),
        L.setChains(e.chains),
        L.setIsAuth(!!e.enableAuthMode),
        L.setIsCustomMobile(!!((t = e.mobileWallets) != null && t.length)),
        L.setIsCustomDesktop(!!((s = e.desktopWallets) != null && s.length)),
  ...
  Ie = (e, t) => {
    ...
    if (re) for (var s of re(t)) Oe.call(t, s) && ne(e, s, t[s]);
    return e;
  },
...
function z(e, t) {
  return O(this, null, function* () {
    let s = Ie({ sdkType: X, sdkVersion: Y }, t),
      o = new URL(e, Q);
    return (
      o.searchParams.append("projectId", x.state.projectId),
...
var k = {
  ...
  Ce = (e, t) => {
    ...
    if (oe) for (var s of oe(t)) We.call(t, s) && ae(e, s, t[s]);
    return e;
  },
  ie = f.isMobile(),
  E = C({
  ...
  _e = {
    ...
    getRecomendedWallets() {
      return O(this, null, function* () {
        let { explorerRecommendedWalletIds: e, explorerExcludedWalletIds: t } =
          x.state;
        if (e === "NONE" || (t === "ALL" && !e)) return E.recomendedWallets;
        if (f.isArray(e)) {
          let s = { recommendedIds: e.join(",") },
            { listings: o } = yield k.getAllListings(s),
            l = Object.values(o);
          l.sort((c, g) => {
          ...
          let { chains: s, isAuth: o } = L.state,
            ...
            { listings: p } = ie
              ? yield k.getMobileListings(g)
              : yield k.getDesktopListings(g);
    ...
    getWallets(e) {
      return O(this, null, function* () {
        ...
        l.length
          ? (t.excludedIds = l.map((v) => v.id).join(","))
          : f.isArray(s) && (t.excludedIds = s.join(",")),
          f.isArray(o) &&
            (t.excludedIds = [t.excludedIds, o].filter(Boolean).join(",")),
          L.state.isAuth && (t.sdks = "auth_v1");
        let { page: c, search: g } = e,
          { listings: p, total: A } = ie
            ? yield k.getMobileListings(t)
            : yield k.getDesktopListings(t),
          r = Object.values(p),
          h = g ? "search" : "wallets";
        return (
          (E[h] = {
  ...
  xe = {
    ...
    open(e) {
      return O(this, null, function* () {
        return new Promise((t) => {
          let { isUiLoaded: s, isDataLoaded: o } = L.state;
          if (
            (f.removeWalletConnectDeepLink(),
            L.setWalletConnectUri(e?.uri),
            L.setChains(e?.chains),
  ...
  De = (e, t) => {
    ...
    if (le) for (var s of le(t)) Pe.call(t, s) && ce(e, s, t[s]);
    return e;
  };
function Me() {
  return (
...
var _ = C({ themeMode: Me() ? "dark" : "light" }),
  $e = {
    state: _,
    subscribe(e) {
      return D(_, () => e(_));
  ...
  U = C({ open: !1, message: "", variant: "success" }),
  Ve = {
    state: U,
    subscribe(e) {
      return D(U, () => e(U));
