import { f as g } from "./chunk-UUTKIRVD.js";
var E = g((L, w) => {
  "use strict";
  ...
  function _() {}
  Object.create &&
    ((_.prototype = Object.create(null)), new _().__proto__ || (c = !1));
  function m(s, t, n) {
  ...
  function x(s, t, n, r, l) {
    ...
    return (
      s._events[o]
        ? s._events[o].fn
          ? (s._events[o] = [s._events[o], f])
          : s._events[o].push(f)
        : ((s._events[o] = f), s._eventsCount++),
      s
    );
  }
  function y(s, t) {
  ...
  u.prototype.eventNames = function () {
    ...
    for (r in (n = this._events)) b.call(n, r) && t.push(c ? r.slice(1) : r);
  ...
  u.prototype.listeners = function (t) {
    ...
    if (!r) return [];
    if (r.fn) return [r.fn];
    for (var l = 0, f = r.length, o = new Array(f); l < f; l++) o[l] = r[l].fn;
    return o;
  };
  ...
  u.prototype.emit = function (t, n, r, l, f, o) {
    ...
    var e = this._events[a],
      ...
      i;
    if (e.fn) {
      switch ((e.once && this.removeListener(t, e.fn, void 0, !0), h)) {
        case 1:
        ...
        case 5:
          return e.fn.call(e.context, n, r, l, f), !0;
        case 6:
          return e.fn.call(e.context, n, r, l, f, o), !0;
      }
      for (i = 1, p = new Array(h - 1); i < h; i++) p[i - 1] = arguments[i];
      e.fn.apply(e.context, p);
    } else {
      var d = e.length,
        v;
      for (i = 0; i < d; i++)
        switch ((e[i].once && this.removeListener(t, e[i].fn, void 0, !0), h)) {
          case 1:
  ...
  u.prototype.removeAllListeners = function (t) {
    ...
    return (
      t
        ? ((n = c ? c + t : t), this._events[n] && y(this, n))
        : ((this._events = new _()), (this._eventsCount = 0)),
      this
    );
  };
